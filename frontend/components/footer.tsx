        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-400">
              Easy Buy is your one-stop shop for all your needs. We provide quality products at competitive prices.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/categories" className="text-sm text-gray-400 hover:text-white">
                  Categories
                </Link>
              </li>
              <li>
